      ...
      <div className="relative border-l border-gray-200 ml-4 md:ml-8 space-y-16 pb-12">
        {[
          { 
            ...
            desc: 'The Karnataka Educational Trust was established in Bengaluru, laying the foundational stone for a legacy dedicated to community empowerment and ethical leadership.' 
          },
          { 
            year: '1997', 
            title: 'Commencement of Academic Voyage', 
            desc: 'Our official education journey began with the establishment of the Physiotherapy division. This strategic entry into higher education set the benchmark for clinical excellence that defines us today.' 
          },
          { 
            year: '2003', 
          ...
          <div key={i} className="relative pl-10 md:pl-16 group">
            ...
            <div className="space-y-2">
              ...
              <h4 className="text-xl font-bold text-[#333333] tracking-tight">
                {item.title}
              </h4>
              <p className="text-[#666666] max-w-3xl font-medium leading-relaxed text-[15px]">
                {item.desc}
              </p>
            </div>
          </div>
