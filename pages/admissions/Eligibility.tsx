      ...
      <div className="space-y-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {eligibilityData.map((cat, i) => (
            <div key={i} className="p-10 bg-gray-50 rounded-[3rem] border border-gray-100 hover:bg-white hover:shadow-2xl transition-all group flex flex-col">
              <div>
                <h3 className="text-xl font-bold text-primary mb-1">{cat.unit}</h3>
